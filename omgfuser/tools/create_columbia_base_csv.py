"""Script for generating a CSV file for the Columbia dataset.
...
AUTHENTIC_PATH: str = "4cam_auth/images"  # Path of the authentic samples.
SPLICED_PATH: str = "4cam_splc/images"    # Path of the manipulated samples.
MASKS_PATH: str = "4cam_splc/mask"        # Path of the mask directory.
MASKS_SUFFIX: str = ".jpg"                # Suffix of the mask files.
...
@click.option("--output_filename", type=str, default="columbia.csv")
def cli(
