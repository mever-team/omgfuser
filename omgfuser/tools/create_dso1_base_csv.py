"""Script for generating a CSV file for the DSO-1 dataset.
...
AUTHENTIC_PATH: str = "authentic"  # Path of the authentic samples.
SPLICED_PATH: str = "spliced"      # Path of the manipulated samples.
MASKS_PATH: str = "masks"          # Path of the mask directory.
MASKS_SUFFIX: str = ".png"         # Suffix of the mask files.
...
@click.option("--output_filename", type=str, default="dso1.csv")
def cli(
