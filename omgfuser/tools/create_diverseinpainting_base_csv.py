"""Script for generating a CSV file for the Diverse Inpainting Dataset.
...
SPLICED_PATH: str = "dl_images"       # Path of the manipulated samples.
MASKS_PATH: str = "dl_masks"          # Path of the mask directory.
MASKS_SUFFIX: str = "_mask.png"             # Suffix of the mask files.
...
@click.option("-d", "--dataset_dir", required=True,
              ...
              help="Base directory of the Diverse Inpainting Dataset.")
@click.option("-o", "--output_dir",
              type=click.Path(exists=True, file_okay=False, path_type=pathlib.Path))
@click.option("--output_filename", type=str, default="diverseinpainting.csv")
def cli(
